...
| ------:       | :-----                                                                                                                              |
| Time/place:   | TuTh 11:30am to 12:20pm in Kent 106                                                                                                 |
| Instructors:  | Asilata Bapat (`asilata` at `math` dot `uchicago` dot `edu`), office hours TBA <br/>Matthew Creek (`mcreek` at `math` dot `uchicago` dot `edu`), office hours TBA |
| College fellow:        | Anthony Wang (`ayw` at `uchicago` dot `edu`)                                                                                  |
